...
public class AcceptanceENDW25Test extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(14, i, 28);
		status=propertyReader.getCellData(14, 1, 20);
		...
		propertyReader.setCellDataXlsx(14, i, 29, s);
