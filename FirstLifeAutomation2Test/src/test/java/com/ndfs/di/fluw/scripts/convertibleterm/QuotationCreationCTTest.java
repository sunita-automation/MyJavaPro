...
public class QuotationCreationCTTest extends FirstLifeTestCaseHelper 
{
	...
	public void quotaionCreation() throws Exception
	{
		...
		Inscode=propertyReader.getCellData2(1, 11, 0);
		InName=propertyReader.getCellData2(1, 11, 1);
		InsdName=propertyReader.getCellData2(1, 11, 2);
		CurCode=propertyReader.getCellData2(1, 11, 3);
		Amount=propertyReader.getCellData2(1, 11, 4);
		Way=propertyReader.getCellData2(1, 11, 5);
		HGht=propertyReader.getCellData2(1, 11, 6);
		WGht=propertyReader.getCellData2(1, 11, 7);
		OccCode=propertyReader.getCellData2(1, 11, 8);
		BeneName=propertyReader.getCellData2(1, 11, 9);
		
		RelCode=propertyReader.getCellData2(1, 11, 10);
		Percentage=propertyReader.getCellData2(1, 11, 11);
		Priority=propertyReader.getCellData2(1, 11, 12);
		...
		repoterLog = extent.createTest("New Quotation Creation CTT result");
		...
		propertyReader.setCellDataXls(1, 11, 13, s1);
