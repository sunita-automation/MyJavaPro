...
public class UnderwrittingReqCTTest extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(9, i, 22);
		Nextstep=propertyReader.getCellData(9, i, 14);
		received=propertyReader.getCellData(9, i, 16);
		...
		propertyReader.setCellDataXlsx(9, i, 23, s);
