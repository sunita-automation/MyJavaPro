...
public class AcceptanceENDW20Test extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(5, i, 28);
		status=propertyReader.getCellData(5, 1, 20);
		...
		propertyReader.setCellDataXlsx(5, i, 29, s);
