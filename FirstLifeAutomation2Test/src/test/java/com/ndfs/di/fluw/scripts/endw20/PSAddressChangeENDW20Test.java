...
public class PSAddressChangeENDW20Test extends FirstLifeTestCaseHelper 
{
	...
	public void AddressChange() throws Throwable 
	{
		...
		insuranceNo = propertyReader.getCellData(8, 12, 1);
	    ...
	    AdressChnageTransationPage.selectPersonsRoleForRopA(Role);
