...
public class PolicyEnquireMRTATest  extends FirstLifeTestCaseHelper {
	...
	public void PolicyEnquiry() throws Throwable 
	{
		//input
		int i=1;
		OfferNo=propertyReader.getCellData(3, i, 26);
		...
		propertyReader.setCellDataXlsx(3, i, 27, s);
		
		//update the policy no in non-financial sheet
		propertyReader.setCellDataXlsx(8, 3, 1, s);
