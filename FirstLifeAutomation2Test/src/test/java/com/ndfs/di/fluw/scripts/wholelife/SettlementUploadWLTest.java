...
public class SettlementUploadWLTest extends FirstLifeTestCaseHelper {
	...
	{
		int i=1;
		username=propertyReader.getCellData(2, 1, 20);
		password=propertyReader.getCellData(2, 1, 21);
		policyno=propertyReader.getCellData(2, i, 31);
		branchcode=propertyReader.getCellData(2, 1, 22);
