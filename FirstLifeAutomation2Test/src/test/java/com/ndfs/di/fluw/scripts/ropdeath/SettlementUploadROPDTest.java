...
public class SettlementUploadROPDTest extends FirstLifeTestCaseHelper {
	...
	{
		int i=1;
		username=propertyReader.getCellData(4, 1, 21);
		password=propertyReader.getCellData(4, 1, 22);
		policyno=propertyReader.getCellData(4, i, 31);
		branchcode=propertyReader.getCellData(4, 1, 23);
