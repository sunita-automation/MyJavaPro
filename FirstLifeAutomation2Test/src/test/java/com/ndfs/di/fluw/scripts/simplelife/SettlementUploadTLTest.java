...
public class SettlementUploadTLTest  extends FirstLifeTestCaseHelper {
	...
	{
		int i=1;
		username=propertyReader.getCellData(1,i, 19);
		password=propertyReader.getCellData(1, i, 20);
		policyno=propertyReader.getCellData(1, i, 27);
		branchcode=propertyReader.getCellData(1, i, 21);
