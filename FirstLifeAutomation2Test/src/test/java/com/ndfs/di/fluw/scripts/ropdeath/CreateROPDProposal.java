...
public class CreateROPDProposal extends FirstLifeTestCaseHelper{
	...
	{	
		//input data
				int i=1;
				productCode=propertyReader.getCellData(4, i, 0);
				Insurer=propertyReader.getCellData(4, i, 1);
				Maininsured=propertyReader.getCellData(4, i, 2);
				Policyterm=propertyReader.getCellData(4, 1, 3);
				sumassured=propertyReader.getCellData(4, i, 5);
				beneficiaryame=propertyReader.getCellData(4, i, 6);
				beneficiaryrelationship=propertyReader.getCellData(4, i, 7);
				Share=propertyReader.getCellData(4, i, 8);	
				PriorityLevel=propertyReader.getCellData(4, i, 9);
				BenefitLife=propertyReader.getCellData(4, i, 10);
				RatioCode=propertyReader.getCellData(4, i, 11);
				SharePercentage=propertyReader.getCellData(4, i, 8);
				Level=propertyReader.getCellData(4, i, 9);
				Height=propertyReader.getCellData(4, i, 12);
				Weight=propertyReader.getCellData(4, i, 13);
				status=propertyReader.getCellData(4, i, 14);
				occuption=propertyReader.getCellData(4, i, 15);
				nextstep=propertyReader.getCellData(4, i, 16);
				...
				propertyReader.setCellDataXlsx(4, i, 26, s);
