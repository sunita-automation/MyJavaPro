...
public class UnderwrittingCTTest extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(9, i, 23);
		Result=propertyReader.getCellData(9, i, 17);
		...
		propertyReader.setCellDataXlsx(9, i, 24, s);
