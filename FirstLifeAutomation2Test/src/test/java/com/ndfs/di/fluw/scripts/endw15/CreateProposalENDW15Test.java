...
public class CreateProposalENDW15Test extends FirstLifeTestCaseHelper{
	...
	public void CreatAProposal() throws Throwable 
	{
		//input data
		int i=1;
		productCode=propertyReader.getCellData(13, i, 0);
		Insurer=propertyReader.getCellData(13, i, 1);
		Maininsured=propertyReader.getCellData(13, i, 2);
		Policyterm=propertyReader.getCellData(13, 1, 3);
		sumassured=propertyReader.getCellData(13, i, 5);
		beneficiaryame=propertyReader.getCellData(13, i, 6);
		beneficiaryrelationship=propertyReader.getCellData(13, i, 7);
		Share=propertyReader.getCellData(13, i, 8);	
		PriorityLevel=propertyReader.getCellData(13, i, 9);
		BenefitLife=propertyReader.getCellData(13, i, 10);
		RatioCode=propertyReader.getCellData(13, i, 11);
		SharePercentage=propertyReader.getCellData(13, i, 8);
		Level=propertyReader.getCellData(13, i, 9);
		Height=propertyReader.getCellData(13, i, 12);
		Weight=propertyReader.getCellData(13, i, 13);
		status=propertyReader.getCellData(13, i, 14);
		occuption=propertyReader.getCellData(13, i, 15);
		nextstep=propertyReader.getCellData(13, i, 16);
		...
		propertyReader.setCellDataXlsx(13, i, 26, s);
