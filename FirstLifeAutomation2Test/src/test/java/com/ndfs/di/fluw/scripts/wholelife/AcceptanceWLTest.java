...
public class AcceptanceWLTest extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(2, i, 28);
		status=propertyReader.getCellData(2, 1, 18);
		...
		propertyReader.setCellDataXlsx(2, i, 29, s);
