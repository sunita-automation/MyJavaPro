...
public class InforceENDW15Test extends FirstLifeTestCaseHelper {
	...
	{
		int i=1;
		username=propertyReader.getCellData(13, 1, 21);
		password=propertyReader.getCellData(13, 1, 22);
		policyno=propertyReader.getCellData(13, i, 31);
		branchcode=propertyReader.getCellData(13, 1, 23);
