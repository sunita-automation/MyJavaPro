...
public class CreateProposalENDW20Test extends FirstLifeTestCaseHelper{
	...
	public void CreatAProposal() throws Throwable 
	{
		//input data
		int i=1;
		productCode=propertyReader.getCellData(5, i, 0);
		Insurer=propertyReader.getCellData(5, i, 1);
		Maininsured=propertyReader.getCellData(5, i, 2);
		Policyterm=propertyReader.getCellData(5, 1, 3);
		sumassured=propertyReader.getCellData(5, i, 5);
		beneficiaryame=propertyReader.getCellData(5, i, 6);
		beneficiaryrelationship=propertyReader.getCellData(5, i, 7);
		Share=propertyReader.getCellData(5, i, 8);	
		PriorityLevel=propertyReader.getCellData(5, i, 9);
		BenefitLife=propertyReader.getCellData(5, i, 10);
		RatioCode=propertyReader.getCellData(5, i, 11);
		SharePercentage=propertyReader.getCellData(5, i, 8);
		Level=propertyReader.getCellData(5, i, 9);
		Height=propertyReader.getCellData(5, i, 12);
		Weight=propertyReader.getCellData(5, i, 13);
		status=propertyReader.getCellData(5, i, 14);
		occuption=propertyReader.getCellData(5, i, 15);
		nextstep=propertyReader.getCellData(5, i, 16);
		...
		propertyReader.setCellDataXlsx(5, i, 26, s);
