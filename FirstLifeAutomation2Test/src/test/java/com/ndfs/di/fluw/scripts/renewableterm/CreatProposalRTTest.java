...
public class CreatProposalRTTest extends FirstLifeTestCaseHelper{
	...
	public void CreatAProposal() throws Throwable 
	{
		//input data
		int i=1;
		productCode=propertyReader.getCellData(10, i, 0);
		Insurer=propertyReader.getCellData(10, i, 1);
		Maininsured=propertyReader.getCellData(10, i, 2);
	//	Policyterm=propertyReader.getCellData(9, i, 3);
		sumassured=propertyReader.getCellData(10, i, 5);
		beneficiaryame=propertyReader.getCellData(10, i, 6);
		beneficiaryrelationship=propertyReader.getCellData(10, i, 7);
		Share=propertyReader.getCellData(10, i, 8);	
		PriorityLevel=propertyReader.getCellData(10, i, 9);
		Height=propertyReader.getCellData(10, i, 10);
		Weight=propertyReader.getCellData(10, i, 11);
		status=propertyReader.getCellData(10, i, 12);
		occuption=propertyReader.getCellData(10, i, 13);
		nextstep=propertyReader.getCellData(10, i, 14);
	...
	//	CreatNewProposalpage.enterPolicyTerm(Policyterm);
		...
		propertyReader.setCellDataXlsx(10, i, 22, s);
