...
public class SettlementUploadENDW25Test extends FirstLifeTestCaseHelper {
	...
	{
		int i=1;
		username=propertyReader.getCellData(14, 1, 21);
		password=propertyReader.getCellData(14, 1, 22);
		policyno=propertyReader.getCellData(14, i, 31);
		branchcode=propertyReader.getCellData(14, 1, 23);
