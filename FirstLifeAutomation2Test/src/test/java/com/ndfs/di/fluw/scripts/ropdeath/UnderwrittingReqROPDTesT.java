...
public class UnderwrittingReqROPDTesT extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(4, i, 26);
		Nextstep=propertyReader.getCellData(4, i, 16);
		received=propertyReader.getCellData(4, i, 18);
		...
		propertyReader.setCellDataXlsx(4, i, 27, s);
