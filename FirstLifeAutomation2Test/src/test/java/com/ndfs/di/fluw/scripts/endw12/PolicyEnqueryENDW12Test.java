...
public class PolicyEnqueryENDW12Test extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input
		int i=1;
		OfferNo=propertyReader.getCellData(12, i, 30);
		...
		propertyReader.setCellDataXlsx(12, i, 31, s);
		Thread.sleep(2000);
