...
public class UnderwrittingReqRTTest extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(10, i, 22);
		Nextstep=propertyReader.getCellData(10, i, 14);
		received=propertyReader.getCellData(10, i, 16);
		...
		propertyReader.setCellDataXlsx(10, i, 23, s);
