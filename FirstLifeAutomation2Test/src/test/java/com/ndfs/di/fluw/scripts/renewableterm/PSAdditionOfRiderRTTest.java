...
public class PSAdditionOfRiderRTTest extends FirstLifeTestCaseHelper{
	...
	// variables
		...
		public void AdditionOfRiders() throws Throwable 
		{
			...
			insuranceNo=propertyReader.getCellData(15, 8, 1);
			Rider1= propertyReader.getCellData(15, 1, 7);
			coating =propertyReader.getCellData(15, 1, 8);
			Rider2=propertyReader.getCellData(15, 2, 7);
			Rider3 = propertyReader.getCellData(15, 3, 7);
			Rider4 =propertyReader.getCellData(15, 4, 7);
