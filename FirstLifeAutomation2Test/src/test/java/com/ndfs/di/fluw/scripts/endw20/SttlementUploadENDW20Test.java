...
public class SttlementUploadENDW20Test extends FirstLifeTestCaseHelper {
	...
	{
		int i=1;
		username=propertyReader.getCellData(5, 1, 21);
		password=propertyReader.getCellData(5, 1, 22);
		policyno=propertyReader.getCellData(5, i, 31);
		branchcode=propertyReader.getCellData(5, 1, 23);
