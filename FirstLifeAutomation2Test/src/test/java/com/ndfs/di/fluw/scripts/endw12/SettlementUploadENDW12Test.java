...
public class SettlementUploadENDW12Test extends FirstLifeTestCaseHelper {
	...
	{
		int i=1;
		username=propertyReader.getCellData(12, 1, 21);
		password=propertyReader.getCellData(12, 1, 22);
		policyno=propertyReader.getCellData(12, i, 31);
		branchcode=propertyReader.getCellData(12, 1, 23);
