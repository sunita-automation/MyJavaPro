...
public class CreateProposalENDW25Test extends FirstLifeTestCaseHelper{
	...
	public void CreatAProposal() throws Throwable 
	{
		//input data
		int i=1;
		productCode=propertyReader.getCellData(14, i, 0);
		Insurer=propertyReader.getCellData(14, i, 1);
		Maininsured=propertyReader.getCellData(14, i, 2);
		Policyterm=propertyReader.getCellData(14, 1, 3);
		sumassured=propertyReader.getCellData(14, i, 5);
		beneficiaryame=propertyReader.getCellData(14, i, 6);
		beneficiaryrelationship=propertyReader.getCellData(14, i, 7);
		Share=propertyReader.getCellData(14, i, 8);	
		PriorityLevel=propertyReader.getCellData(14, i, 9);
		BenefitLife=propertyReader.getCellData(14, i, 10);
		RatioCode=propertyReader.getCellData(14, i, 11);
		SharePercentage=propertyReader.getCellData(14, i, 8);
		Level=propertyReader.getCellData(14, i, 9);
		Height=propertyReader.getCellData(14, i, 12);
		Weight=propertyReader.getCellData(14, i, 13);
		status=propertyReader.getCellData(14, i, 14);
		occuption=propertyReader.getCellData(14, i, 15);
		...
		propertyReader.setCellDataXlsx(14, i, 26, s);
