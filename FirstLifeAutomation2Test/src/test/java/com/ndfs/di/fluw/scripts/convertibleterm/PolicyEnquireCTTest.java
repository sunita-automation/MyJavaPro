...
public class PolicyEnquireCTTest  extends FirstLifeTestCaseHelper {
	...
	public void PolicyEnquiry() throws Throwable 
	{
		//input
		int i=1;
		OfferNo=propertyReader.getCellData(9, i, 26);
		
		
		
		//login details
		 repoterLog = extent.createTest("Policy Enquery CTT Result");
		...
		propertyReader.setCellDataXlsx(9, i, 27, s);
