...
public class UnderwrittingReqMRTATest extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(3, i, 22);
		Nextstep=propertyReader.getCellData(3, i, 14);
		received=propertyReader.getCellData(3, i, 16);
		...
		propertyReader.setCellDataXlsx(3, i, 23, s);
