...
public class UnderwrittingULTest extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(11, i, 27);
		Result=propertyReader.getCellData(11, 1, 19);
		...
		propertyReader.setCellDataXlsx(11, i, 28, s);
