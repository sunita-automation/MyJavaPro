...
public class UnderwrittingReqENDW15Test extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(13, i, 26);
		Nextstep=propertyReader.getCellData(13, i, 16);
		received=propertyReader.getCellData(13, i, 18);
		...
		propertyReader.setCellDataXlsx(13, i, 27, s);
