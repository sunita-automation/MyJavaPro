...
public class UnderwrittingReqULTest extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(11, i, 26);
		Nextstep=propertyReader.getCellData(11, i, 16);
		received=propertyReader.getCellData(11, i, 18);
		...
		propertyReader.setCellDataXlsx(11, i, 27, s);
