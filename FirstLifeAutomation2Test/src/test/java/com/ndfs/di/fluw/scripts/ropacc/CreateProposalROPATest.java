...
public class CreateProposalROPATest extends FirstLifeTestCaseHelper{
	...
	{	
		//input data
				int i=1;
				productCode=propertyReader.getCellData(6, i, 0);
				Insurer=propertyReader.getCellData(6, i, 1);
				Maininsured=propertyReader.getCellData(6, i, 2);
				Policyterm=propertyReader.getCellData(6, 1, 3);
				sumassured=propertyReader.getCellData(6, i, 5);
				beneficiaryame=propertyReader.getCellData(6, i, 6);
				beneficiaryrelationship=propertyReader.getCellData(6, i, 7);
				Share=propertyReader.getCellData(6, i, 8);	
				PriorityLevel=propertyReader.getCellData(6, i, 9);
				BenefitLife=propertyReader.getCellData(6, i, 10);
				RatioCode=propertyReader.getCellData(6, i, 11);
				SharePercentage=propertyReader.getCellData(6, i, 8);
				Level=propertyReader.getCellData(6, i, 9);
				Height=propertyReader.getCellData(6, i, 12);
				Weight=propertyReader.getCellData(6, i, 13);
				status=propertyReader.getCellData(6, i, 14);
				occuption=propertyReader.getCellData(6, i, 15);
				...
				propertyReader.setCellDataXlsx(6, i, 26, s);
