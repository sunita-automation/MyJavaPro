...
public class PSAddressChangeROPDTest extends FirstLifeTestCaseHelper
{
	...
	public void AddressChange() throws Throwable 
	{
		...
		insuranceNo = propertyReader.getCellData(8, 4, 1);
	    ...
	    AdressChnageTransationPage.selectPersonsRoleRopd(Role);
