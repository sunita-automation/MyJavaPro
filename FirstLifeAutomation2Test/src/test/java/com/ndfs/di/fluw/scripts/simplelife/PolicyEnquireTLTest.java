...
public class PolicyEnquireTLTest  extends FirstLifeTestCaseHelper {
	...
	public void PolicyEnquiry() throws Throwable 
	{
		//input
		int i=1;
		OfferNo=propertyReader.getCellData(1, i, 26);
		...
		propertyReader.setCellDataXlsx(1, i, 27, s);
		
		//update the policy no in non-financial sheet
		propertyReader.setCellDataXlsx(8, 1, 1, s);
