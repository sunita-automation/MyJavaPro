...
public class UnderwrittingReqENDW20Test extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(5, i, 26);
		Nextstep=propertyReader.getCellData(5, i, 16);
		received=propertyReader.getCellData(5, i, 18);
		...
		propertyReader.setCellDataXlsx(5, i, 27, s);
