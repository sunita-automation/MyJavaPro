...
public class CreatProposalTLTest extends FirstLifeTestCaseHelper{
	...
	public void CreatAProposal() throws Throwable 
	{
		//input data
		int i=1;
		productCode=propertyReader.getCellData(1, i, 0);
		Insurer=propertyReader.getCellData(1, i, 1);
		Maininsured=propertyReader.getCellData(1, i, 2);
		Policyterm=propertyReader.getCellData(1, 1, 3);
		sumassured=propertyReader.getCellData(1, i, 5);
		beneficiaryame=propertyReader.getCellData(1, i, 6);
		beneficiaryrelationship=propertyReader.getCellData(1, i, 7);
		Share=propertyReader.getCellData(1, i, 8);	
		PriorityLevel=propertyReader.getCellData(1, i, 9);
		Height=propertyReader.getCellData(1, i, 10);
		Weight=propertyReader.getCellData(1, i, 11);
		status=propertyReader.getCellData(1, i, 12);
		occuption=propertyReader.getCellData(1, i, 13);
		...
		propertyReader.setCellDataXlsx(1, i, 22, s);
