...
public class AcceptanceULTest extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(11, i, 28);
		status=propertyReader.getCellData(11, 1, 20);
		...
		propertyReader.setCellDataXlsx(11, i, 29, s);
