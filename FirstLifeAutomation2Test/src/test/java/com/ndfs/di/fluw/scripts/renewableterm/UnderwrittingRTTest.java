...
public class UnderwrittingRTTest extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(10, i, 23);
		Result=propertyReader.getCellData(10, i, 17);
		...
		propertyReader.setCellDataXlsx(10, i, 24, s);
