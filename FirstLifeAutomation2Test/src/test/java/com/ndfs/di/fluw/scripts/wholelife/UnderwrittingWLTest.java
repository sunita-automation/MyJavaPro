...
public class UnderwrittingWLTest extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(2, i, 27);
		Result=propertyReader.getCellData(2, 1, 17);
		...
		propertyReader.setCellDataXlsx(2, i, 28, s);
