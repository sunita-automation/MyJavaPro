...
public class AcceptanceRTTest extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(10, i, 24);
		status=propertyReader.getCellData(10, i, 18);
		...
		propertyReader.setCellDataXlsx(10, i, 25, s);
