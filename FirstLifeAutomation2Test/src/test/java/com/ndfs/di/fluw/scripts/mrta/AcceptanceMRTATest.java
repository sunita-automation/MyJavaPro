...
public class AcceptanceMRTATest extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(3, i, 24);
		status=propertyReader.getCellData(3, i, 18);
		...
		propertyReader.setCellDataXlsx(3, i, 25, s);
