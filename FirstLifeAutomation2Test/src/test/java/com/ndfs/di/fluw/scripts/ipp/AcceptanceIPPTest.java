...
public class AcceptanceIPPTest extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		...
		num=propertyReader.getCellData(0, i, 24);
		status=propertyReader.getCellData(0, 1, 18);
		...
		propertyReader.setCellDataXlsx(0, i, 25, s);
