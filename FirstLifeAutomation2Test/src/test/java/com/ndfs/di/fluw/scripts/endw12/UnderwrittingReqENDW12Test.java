...
public class UnderwrittingReqENDW12Test extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(12, i, 26);
		Nextstep=propertyReader.getCellData(12, i, 16);
		received=propertyReader.getCellData(12, i, 18);
		...
		propertyReader.setCellDataXlsx(12, i, 27, s);
