...
public class QuotationCreationENDW25Test extends FirstLifeTestCaseHelper {
	...
	{
		Inscode=propertyReader.getCellData2(1, 33, 0);
		InName=propertyReader.getCellData2(1, 33, 1);
		InsdName=propertyReader.getCellData2(1,33, 2);
		CurCode=propertyReader.getCellData2(1, 33, 3);
		Amount=propertyReader.getCellData2(1, 33, 4);
		Way=propertyReader.getCellData2(1, 33, 5);
		HGht=propertyReader.getCellData2(1, 33, 6);
		WGht=propertyReader.getCellData2(1, 33, 7);
		OccCode=propertyReader.getCellData2(1, 33, 8);
		BeneName=propertyReader.getCellData2(1, 33, 9);
		RelCode=propertyReader.getCellData2(1, 33, 10);
		Percentage=propertyReader.getCellData2(1, 33, 11);
		Priority=propertyReader.getCellData2(1, 33, 12);
		BenefitLife =propertyReader.getCellData2(1, 33, 15);
		RatioCode=propertyReader.getCellData2(1, 33, 10);
		SharePercentage=propertyReader.getCellData2(1, 33, 11);
		Level=propertyReader.getCellData2(1, 33, 12);
		...
		//SCRIPTS
				...
				propertyReader.setCellDataXls(1, 33, 13, s1);
				Thread.sleep(2000);
