...
public class ConversionCTTest extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(9, i, 25);
				
				
				
				
		//login details
		 repoterLog = extent.createTest("Cnversion CTT Result");
		...
		propertyReader.setCellDataXlsx(9, i, 26, s);
