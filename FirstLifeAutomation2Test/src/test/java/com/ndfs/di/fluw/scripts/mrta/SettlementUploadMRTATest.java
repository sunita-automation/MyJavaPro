...
public class SettlementUploadMRTATest  extends FirstLifeTestCaseHelper {
	...
	{
		int i=1;
		username=propertyReader.getCellData(3,i, 19);
		password=propertyReader.getCellData(3, i, 20);
		policyno=propertyReader.getCellData(3, i, 27);
		branchcode=propertyReader.getCellData(3, i, 21);
