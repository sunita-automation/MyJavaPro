...
public class UnderwrittingENDW15Test extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(13, i, 27);
		Result=propertyReader.getCellData(13, 1, 19);
		...
		propertyReader.setCellDataXlsx(13, i, 28, s);
