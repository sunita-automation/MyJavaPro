...
public class UnderwrittingENDW25Test extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(14, i, 27);
		Result=propertyReader.getCellData(14, 1, 19);
		...
		propertyReader.setCellDataXlsx(14, i, 28, s);
