...
public class UnderwrittingMRTATest extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(3, i, 23);
		Result=propertyReader.getCellData(3, i, 17);
		...
		propertyReader.setCellDataXlsx(3, i, 24, s);
