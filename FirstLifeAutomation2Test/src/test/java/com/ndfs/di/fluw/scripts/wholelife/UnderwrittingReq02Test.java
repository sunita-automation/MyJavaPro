...
public class UnderwrittingReq02Test extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(2, i, 26);
		Nextstep=propertyReader.getCellData(2, i, 14);
		received=propertyReader.getCellData(2, i, 16);
		...
		propertyReader.setCellDataXlsx(2, i, 27, s);
