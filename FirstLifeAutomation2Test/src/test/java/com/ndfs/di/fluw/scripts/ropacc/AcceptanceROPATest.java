...
public class AcceptanceROPATest extends FirstLifeTestCaseHelper{
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input data
		int i=1;
		num=propertyReader.getCellData(6, i, 28);
		status=propertyReader.getCellData(6, 1, 20);
		...
		propertyReader.setCellDataXlsx(6, i, 29, s);
