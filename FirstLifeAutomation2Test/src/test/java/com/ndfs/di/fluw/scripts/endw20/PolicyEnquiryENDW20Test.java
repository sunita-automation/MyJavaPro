...
public class PolicyEnquiryENDW20Test extends FirstLifeTestCaseHelper {
	...
	public void UnderwrittingRequirement() throws Throwable 
	{
		//input
		int i=1;
		OfferNo=propertyReader.getCellData(5, i, 30);
		...
		propertyReader.setCellDataXlsx(5, i, 31, s);
		
		//update the policy no in non-financial sheet
		propertyReader.setCellDataXlsx(8, 12, 1, s);
		Thread.sleep(2000);
